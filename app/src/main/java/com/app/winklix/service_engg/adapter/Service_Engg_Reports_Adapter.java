...
public class Service_Engg_Reports_Adapter extends RecyclerView.Adapter<Service_Engg_Reports_Adapter.MyHolder> {

    private ArrayList<Service_Engg_Reports_Holder> userList;
    ...
    public Service_Engg_Reports_Adapter(Context montext, ArrayList<Service_Engg_Reports_Holder> msgArrayList) {
    ...
    public void onBindViewHolder(final MyHolder holder, final int position) {
        final Service_Engg_Reports_Holder mOdelq = userList.get(position);
        ...
        holder.layoutItem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                bundle.putString("autoId", mOdelq.getEngg_Id());
